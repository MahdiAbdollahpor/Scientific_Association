...
namespace DataLayer.Migrations
{
    ...
    [Migration("20250808100459_AddEventsAndEventRegistrations")]
    partial class AddEventsAndEventRegistrations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataLayer.Models.Event.Event", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataLayer.Models.Event.EventRegistration", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataLayer.Models.Item.News", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataLayer.Models.Item.NewsImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataLayer.Models.Event.EventRegistration", b =>
                {
                    b.HasOne("DataLayer.Models.Event.Event", "Event")
            ...
            modelBuilder.Entity("DataLayer.Models.Item.NewsImage", b =>
                {
                    b.HasOne("DataLayer.Models.Item.News", "News")
                        .WithMany("Images")
